const songlist = [
  {
    song: new Audio("/PROJECTS/ASSETS/SONGS/Apna Bana le.mp3"),
    mood: "Travel",
    name: "Apna Bana le",
    artist: "Arjit Singh",
  ...
  {
    song: new Audio("/PROJECTS/ASSETS/SONGS/Aya na tu.mp3"),
    mood: "Travel",
    name: "Aya Na Tu",
  ...
  {
    song: new Audio("/PROJECTS/ASSETS/SONGS/Enna Sona.mp3"),
    mood: "Travel",
    name: "Enna Sona",
    artist: "Arjit Singh",
  ...
  {
    song: new Audio("/PROJECTS/ASSETS/SONGS/Tu Aake dekh le.mp3"),
    mood: "Travel",
  ...
  {
    song: new Audio("/PROJECTS/ASSETS/SONGS/Tu hi yaar mera.mp3"),
    mood: "Travel",
  ...
  {
    song: new Audio("/PROJECTS/ASSETS/SONGS/Tum Hi Ho.mp3"),
    mood: "Romance",
    name: "Tum Hi Ho",
    artist: "Arjit Singh",
  ...
  {
    song: new Audio("/PROJECTS/ASSETS/SONGS/Agar tum Saath ho.mp3"),
    mood: "Romance",
  ...
  {
    song: new Audio("/PROJECTS/ASSETS/SONGS/Let Me Love You.mp3"),
    mood: "Romance",
  ...
  {
    song: new Audio("/PROJECTS/ASSETS/SONGS/Let Me Down Slowly.mp3"),
    mood: "Romance",
  ...
  {
    song: new Audio("/PROJECTS/ASSETS/SONGS/Love Me Like You Do.mp3"),
    mood: "Romance",
  ...
  {
    song: new Audio("/PROJECTS/ASSETS/SONGS/saturday-saturday.mp3"),
    mood: "Party",
  ...
  {
    song: new Audio("/PROJECTS/ASSETS/SONGS/paagal.mp3"),
    mood: "Party",
    name: "Paagal",
    artist: "Baadshah",
  ...
  {
    song: new Audio("/PROJECTS/ASSETS/SONGS/Nashe Si Chad Gayi.mp3"),
    mood: "Party",
  ...
  {
    song: new Audio("/PROJECTS/ASSETS/SONGS/party all night.mp3"),
    mood: "Party",
  ...
  {
    song: new Audio("/PROJECTS/ASSETS/SONGS/Naacho.mp3"),
    mood: "Party",
    name: "Naacho",
  ...
  {
    song: new Audio("/PROJECTS/ASSETS/SONGS/Baarishein.mp3"),
    mood: "Sad",
    name: "Baarishein",
    artist: "Anuv Jain",
  ...
  {
    song: new Audio("/PROJECTS/ASSETS/SONGS/Kabira.mp3"),
    mood: "Sad",
    name: "Kabira",
    artist: "Arjit Singh",
  ...
  {
    song: new Audio("/PROJECTS/ASSETS/SONGS/Ranjha.mp3"),
    mood: "Sad",
    name: "Ranjha",
    artist: "B Praak",
  ...
  {
    song: new Audio("/PROJECTS/ASSETS/SONGS/Lahore.mp3"),
    mood: "Punjabi",
    name: "Lahore",
  ...
  {
    song: new Audio("/PROJECTS/ASSETS/SONGS/Gaal Ni Kadni.mp3"),
    mood: "Punjabi",
    name: "Gaal Ni Kadni",
  ...
  {
    song: new Audio("/PROJECTS/ASSETS/SONGS/Prada.mp3"),
    mood: "Punjabi",
    name: "Prada",
    artist: "Jass Manak",
  ...
  {
    song: new Audio("/PROJECTS/ASSETS/SONGS/Cheques.mp3"),
    mood: "Punjabi",
    name: "Cheque",
    artist: "Shubh",
  ...
  {
    song: new Audio("/PROJECTS/ASSETS/SONGS/Rubicon Drill.mp3"),
    mood: "Punjabi",
    name: "Rubicon Drill",
    artist: "Parmish Verma",
  ...
  {
    song: new Audio("/PROJECTS/ASSETS/SONGS/dena-ho-to-dijiye-janam-janam.mp3"),
    mood: "Bhajan",
  ...
  ,
  {
    song: new Audio("/PROJECTS/ASSETS/SONGS/Koi Jaaye Jo Vrindavan - PagalRingtone.Com.mp3"),
    mood: "Bhajan",
  ...
  ,
  {
    song: new Audio("/PROJECTS/ASSETS/SONGS/Saanwara - Maanya Arora, Shubham Bajoria - Krishna Bhajan.mp3"),
    mood: "Bhajan",
